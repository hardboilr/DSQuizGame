...
import java.util.Scanner;
     ...
     *  ArrayList<String> as = new ArrayList<String>();
        ...
        outof = FileHandler.load("persons.txt");
        for (String line : outof) {
        e    System.out.println("Person: " + line);
        }   
     * 
...
public class FileHandler
{
    ...
    public static boolean savePersons2(ArrayList<Person> personArray, String filename) {
        ...
        try {
            output = new FileWriter(filename);  //Opening connection to file.
            for (Person personline : personArray) {   //running through the ArrayList.                    
                output.write(personline.getPersonName() + ":");  //Each String object is written as a line in file.
                output.write(personline.getRoleScore().toString().replaceAll("\\[", "").replaceAll("\\]", "") + "\n");
            }
